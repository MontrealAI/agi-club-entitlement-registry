...
bind('revoke',()=>preview('revokeBatch',[idRequired(),members(),hashReason()],t('Révoquer les droits actifs. Rapprochez séparément les prestations, réservations ou accès déjà accordés.')));
