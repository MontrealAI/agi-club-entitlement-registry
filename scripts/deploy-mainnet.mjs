...
try {
 ...
 const final=await provider.getBlock('finalized');save('.local/mainnet-deployment.json',{...checked,transactionHash:tx.hash,blockNumber:receipt.blockNumber,blockHash:receipt.blockHash,finalized:!!final&&final.number>=receipt.blockNumber,sourceSha256:plan.sourceSha256,broadMemberLaunchAuthorized:false});
