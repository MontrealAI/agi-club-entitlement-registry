...
const report={version:'2.3.0-rc.1',status:'NOT_EXECUTED',at:new Date().toISOString(),realDependencyRequired:'ethers@'+expectedEthersVersion};
...
try{
 ...
 const allow=['index.html','admin.html','member.html','style.css','config.js','app.js','deployment.html','deployment.js','member.js','verify.html','verify.js','privacy.html','legal.html','private-memory.mjs','contract-abi.mjs','etherscan.html','etherscan.css','etherscan.js','etherscan-tools.mjs','etherscan-abi.mjs','_headers'];
