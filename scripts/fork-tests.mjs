...
try {
 ...
 const identity=await checkProduction(provider,await c.getAddress(),realAdmin);report.identity=identity;report.sourceSha256=sourceDigest().sourceSha256;report.forkBlock={number:pinned,hash:block.hash};
