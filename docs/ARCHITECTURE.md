...
Repository 2.4.0-rc.3; contract 2.1.1; request /4. Earlier /3 and /2.x requests are incompatible and must be regenerated from an existing valid claim. No new on-chain claim is required merely to update the receipt format.
