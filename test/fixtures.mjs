...
export async function fixture(){
 const policy={origin:'https://claims.example.org',chainId:1,registry:'0x'+'11'.repeat(20),registryCodeHash:'0x'+'22'.repeat(32),version:REGISTRY_VERSION,entitlements:[id('IA101_2026_09_22')]};
